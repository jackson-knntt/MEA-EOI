...
// Sole Trader (£500) Stripe payment link.
const SOLE_TRADER_STRIPE_LINK = "https://buy.stripe.com/8x29AV9PZ6jK51n8Hx8g00n";

export default function SoleTraderApplyPage() {
  ...
  async function handleSubmit(ev) {
    ...
    try {
      ...
      const res = await fetch("/apply/sole-trader/api/submit", {
        method: "POST",
      ...
      setTimeout(() => {
        window.location.href = SOLE_TRADER_STRIPE_LINK;
      }, 1500);
          ...
          <div className="form-card">
            <div className="section-header" style={{ background: "#1e6b3c" }}>
              ...
              <div>
                ...
                <p>Your Sole Trader Membership is now active</p>
              </div>
            </div>
            <div className="form-body">
              <p className="intro-text">
                Thank you for completing your Sole Trader Membership. We look forward
        ...
        <form className="form-card" onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-body">
            ...
            <p className="intro-text">
              ...
              We just need a few more details to complete your Sole Trader Membership
          ...
          <div className="section-header">
            ...
            <div>
              <h2>Terms &amp; Payment</h2>
              <p>£500 + VAT — secure payment via Stripe</p>
            </div>
          </div>
          <div className="form-body">
            ...
            <div className="terms-box">
              <p>
                I apply for Sole Trader Membership of The Middle East Association and agree,
                if accepted, to be bound by the Memorandum and Articles of Association.
                I further give explicit consent for The Middle East Association to
                communicate with me for membership and marketing purposes. Membership
              ...
              <div className="check-row">
                ...
                <label htmlFor="terms">
                  I have read and accept the terms and conditions of Sole Trader Membership
                </label>
              </div>
              {termsError && (
      ...
      <div className="header">
        <div className="header-inner">
          ...
          <div className="header-text">
            ...
            <p>Sole Trader Membership — £500 + VAT per year</p>
          </div>
        </div>
      </div>
